        ...
        <div class="card container mt-4">
            ...
            <form action="{{route('productos.update', $producto)}}" method="POST" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="precio" id="precio" value="{{old('precio',$producto->precio)}}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" disabled class="form-control" name="fecha_creacion" id="fecha_creacion" value="{{old('fecha_creacion',$producto->fecha_creacion)}}">

                </div> 
                <div class="col-md-2">
                    <label for="peso" class="form-label">Peso</label>
                    <input type="number" class="form-control" name="peso" id="peso" value="{{old('peso',$producto->peso)}}"> 
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control" name="stock" id="stock" value="{{old('stock',$producto->stock)}}">
